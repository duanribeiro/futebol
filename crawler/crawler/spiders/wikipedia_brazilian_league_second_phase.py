...
class WikipediaBrazilianLeagueSecondPhase(scrapy.Spider):
    ...
    def start_requests(self):
        url = f'https://pt.wikipedia.org/wiki/Resultados_do_segundo_turno_do_Campeonato_Brasileiro_de_Futebol_de_2019_-_S%C3%A9rie_A'
    ...
    def parse(self, response):
        ...
        for table in range(3, 193) :
            try:
                ...
                basic_info = response.xpath(f'//*[@id="mw-content-text"]/div/table[{table}]').css('tbody').css('tr')[0].css('td')
